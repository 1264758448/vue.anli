    ...
    <div>
        ...
        <div class="mui-content">
		        <ul class="mui-table-view mui-grid-view mui-grid-9 my-ul">
		            ...
		            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4"><router-link to="/home/shangpin1" class='a'>
		                    <img src='../../assets/menu3.png'></img>
